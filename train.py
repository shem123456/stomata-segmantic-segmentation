...
def generate_arrays_from_file(lines,batch_size):
    ...
    while 1:
        ...
        for _ in range(batch_size):
            ...
            # 从文件中读取图像
            print(name)
            img = Image.open(r".\dataset1\jpg" + '/' + name)
            ...
            # 从文件中读取图像
            img = Image.open(r".\dataset1\png" + '/' + name)
...
if __name__ == "__main__":
    ...
    # print(weight_path)
    # model.load_weights('logs/last1.h5',by_name=True,skip_mismatch=True)

    # model.summary()
    # 打开数据集的txt
    with open(r".\dataset1\train.txt","r") as f:
        lines = f.readlines()
